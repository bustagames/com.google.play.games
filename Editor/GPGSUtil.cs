...
namespace GooglePlayGames.Editor
{
    ...
    public static class GPGSUtil
    {
        ...
        // The official unitypackage installs under Assets/GooglePlayGames. This project vendors
        // the package through Packages/, so its generated Android manifest must remain in Assets.
        private const string EmbeddedPackageManifestRelativePath =
        ...
        private static string ManifestPath
        {
            get
            {
                var manifestRelativePath = RootPath.StartsWith(
                    "Packages" + Path.DirectorySeparatorChar,
                    StringComparison.Ordinal)
                    ? EmbeddedPackageManifestRelativePath
